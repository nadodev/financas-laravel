                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <div class="flex items-center">
                                    <input id="is_recurring" name="is_recurring" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500" {{ old('is_recurring') ? 'checked' : '' }}>
                            ...
                            <div id="recurrence_fields" class="hidden">
                                <div>
                                    ...
                                    <select id="recurrence_interval" name="recurrence_interval" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm">
                                        <option value="monthly" {{ old('recurrence_interval') === 'monthly' ? 'selected' : '' }}>Mensal</option>
                                        <option value="weekly" {{ old('recurrence_interval') === 'weekly' ? 'selected' : '' }}>Semanal</option>
                                        <option value="yearly" {{ old('recurrence_interval') === 'yearly' ? 'selected' : '' }}>Anual</option>
                                    </select>
                                ...
                                <div class="mt-4">
                                    ...
                                    <x-text-input id="recurrence_end_date" name="recurrence_end_date" type="date" class="mt-1 block w-full" :value="old('recurrence_end_date')" />
